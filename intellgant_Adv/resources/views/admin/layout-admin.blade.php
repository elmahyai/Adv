                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{route('admin.home')}}" class="nav-link active">
                                    ...
                                    <p>{{trans('admin/layout.Home')}}</p>
                                </a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-header">{{trans('admin/layout.Options')}}</li>
                    <li class="nav-item">
                        <a href="{{route('client.index')}}" class="nav-link">
                            <i class="nav-icon far fa-user"></i>
                            <p>
                                {{trans('admin/layout.customers_account')}}
                            </p>
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="{{route('screen.index')}}" class="nav-link">
                            ...
                            <p>
                                {{trans('admin/layout.Screens')}}
                            </p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{route('advModel.index')}}" class="nav-link">
                            <i class="nav-icon fa fa-plus-circle"></i>
                            <p>
                                {{trans('admin/layout.Models')}}
                            </p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{route('model_class.index')}}" class="nav-link">
                            <i class="nav-icon fa fa-address-book"></i>
                            <p>
                                {{trans('admin/layout.Models_class')}}
                            </p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{route('admin.statistics')}}" class="nav-link">
                            ...
                            <p>
                                {{trans('admin/layout.Statistical_Reports')}}
                            </p>
                        </a>
                    </li>
